...
> 🚀 **فقط می‌خواهید رایگان و سریع تست کنید؟**
> [`DEPLOY-FREE.md`](./DEPLOY-FREE.md) را بخوانید — استقرار رایگان روی Vercel و Neon
> با دامنه و HTTPS رایگان، تماماً در مرورگر و بدون نصب چیزی. حدود ۲۰ دقیقه.
> این سند برای راه‌اندازی واقعی باشگاه (میزبان ایرانی، درگاه و پیامک واقعی) است.
